...
const ar = {
  ...
  "spin.reset": "تم تصفير اللعبة — جاهزة من جديد",
  "spin.resetError": "تعذر تصفير اللعبة",
  "spin.resetHidden": "تصفير اللعبة",
  "spin.resetConfirmTitle": "تأكيد التصفير",
  "spin.resetConfirmBody": "هل تريد تصفير اللعبة وبدء جولة جديدة؟",
